...
#LECTURA DE DATOS
library(readxl)
vivienda <- read_excel('vivienda1.xlsx')
vivienda$No=NULL
vivienda$X1=NULL
vivienda$Y=NULL
View(vivienda)
...
24.96772
121.5410
vc<-c(1.5,23.38284, 7 ,24.96772, 121.5410) #-- valores correspondientes a cada variable. 
vc.est<-(vc-medias)/sqrt(varianza)#estandarizando
vc.est#COMPARAMOS CON LA FILA 20 de la data 'vivienda.s'
###autovectores
acp1$c1
...
#
acp1$c1#AUTOVECTORES
#metiendo_FILA_1_estandarizada- 'vc.est'
comp<-function(a1){
